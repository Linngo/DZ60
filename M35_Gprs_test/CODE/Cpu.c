...
loop:
    ...
    /*
     * Delay
     *   - requested                  : 100 us @ 11.0592MHz,
     *   - possible                   : 1106 c, 100007.23 ns, delta 7.23 ns
     *   - without removable overhead : 1098 c, 99283.85 ns
     */
    pshh                               /* (2 c: 180.84 ns) backup H */
    pshx                               /* (2 c: 180.84 ns) backup X */
    ldhx #$0087                        /* (3 c: 271.27 ns) number of iterations */
label0:
    aix #-1                            /* (2 c: 180.84 ns) decrement H:X */
    cphx #0                            /* (3 c: 271.27 ns) compare it to zero */
    bne label0                         /* (3 c: 271.27 ns) repeat 135x */
    pulx                               /* (3 c: 271.27 ns) restore X */
    pulh                               /* (3 c: 271.27 ns) restore H */
    nop                                /* (1 c: 90.42 ns) wait for 1 c */
    nop                                /* (1 c: 90.42 ns) wait for 1 c */
    nop                                /* (1 c: 90.42 ns) wait for 1 c */
    nop                                /* (1 c: 90.42 ns) wait for 1 c */
    nop                                /* (1 c: 90.42 ns) wait for 1 c */
...
/* NVPROT: EPS=3,FPS=0x2B */
const unsigned char NVPROT_INIT @0x0000FFBD = 0xEB;

/* NVOPT: KEYEN=0,FNORED=0,EPGMOD=1,??=1,??=1,??=1,SEC1=1,SEC0=0 */
