...
static void HWEnDi(void)
{
  if (EnUser) {
    ...
    setReg8(RTCSC, 0xD9);              /* Run RTC - select clock source; set frequency and enable interrupt */ 
  } else {
    /* RTCSC: RTCPS=0 */
...
void TI1_Init(void)
{
  ...
  TI1_SetCV(0x9B);                     /* Inicialize appropriate value to the compare/modulo/reload register */
